    ...
    if not st.session_state.get("desktop_notice_shown", False):
        ...
        def _desktop_notice_body():
            st.markdown(
                ...
                "<svg width='54' height='34' viewBox='0 0 100 60' style='flex:none;'>"
                "<rect x='2' y='6' width='96' height='48' rx='24' fill='#E7EBEC'/>"
                "<circle cx='74' cy='30' r='23' fill='#FFFFFF' stroke='#20313A' stroke-width='2'/>"
                "<circle cx='74' cy='30' r='7' fill='none' stroke='#20313A' stroke-width='2.4'/>"
                "<g stroke='#20313A' stroke-width='2.4' stroke-linecap='round'>"
                "<path d='M74 16 v3.5'/><path d='M74 40.5 v3.5'/>"
                "<path d='M60 30 h3.5'/><path d='M84.5 30 h3.5'/>"
                "<path d='M64.5 20.5 l2.5 2.5'/><path d='M81 37 l2.5 2.5'/>"
                "<path d='M83.5 20.5 l-2.5 2.5'/><path d='M67 37 l-2.5 2.5'/>"
                "</g>"
                "<text x='14' y='36' font-family='Barlow, sans-serif' font-size='15' "
                "font-weight='800' fill='#20313A'>DAY</text>"
                "</svg>"
                "<div><b style='color:#0C4A5A;'>Use day mode</b><br>"
                "<span style='color:#3E5964;'>The colours were chosen for a light background. "
                "If your browser is set to dark mode, switch it to light so the charts read "
                "the way they were designed.</span></div>"
                "</div>"
        ...
        if not notice_rendered:
            st.markdown(
                ...
                "<svg width='42' height='27' viewBox='0 0 100 60' style='flex:none;'>"
                "<rect x='2' y='6' width='96' height='48' rx='24' fill='#E7EBEC'/>"
                "<circle cx='74' cy='30' r='23' fill='#FFFFFF' stroke='#20313A' stroke-width='2'/>"
                "<circle cx='74' cy='30' r='7' fill='none' stroke='#20313A' stroke-width='2.4'/>"
                "<g stroke='#20313A' stroke-width='2.4' stroke-linecap='round'>"
                ...
                "font-weight='800' fill='#20313A'>DAY</text>"
                "</svg>"
                "<div><b>Use day mode</b><br>"
                "The colours were chosen for a light background. Switch your browser out of "
                "dark mode for the intended view.</div>"
                "</div>"
                "<p style='color:#5A7480;font-size:14px;margin-top:12px;margin-bottom:0;'>"
                "You can keep browsing on mobile — just expect some scrolling and not a perfect view.</p>"
                "</div>",
                unsafe_allow_html=True
            )
